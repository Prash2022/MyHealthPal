...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String qry1 = "create table users(username text, email text, password text, fullname text, address text, phone text)";
    ...
    public int checkAppointmentExists(String username, String fullname, String address,
...
// Check if the cursor has data and move to the first row
    ...
    public void updateUser(String username, String email, String fullname, String address, String phone) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues cv = new ContentValues();
